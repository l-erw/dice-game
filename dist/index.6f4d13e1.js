...
function roll() {
    ...
    if (player1Turn) {
        ...
        if (currentClass) player1dice.classList.remove(currentClass);
        ...
        if (playerTwoCurrentClass) player2dice.classList.remove(playerTwoCurrentClass);
...
//# sourceMappingURL=index.6f4d13e1.js.map
